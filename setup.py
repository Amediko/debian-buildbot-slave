...
class our_install_data(install_data):
    ...
    def run(self):
        ...
        # ensure there's a buildbot-worker/VERSION file
        fn = os.path.join(self.install_dir, 'buildbot-worker', 'VERSION')
...
class our_sdist(sdist):
    ...
    def make_release_tree(self, base_dir, files):
        ...
        fn = os.path.join(base_dir, 'buildbot-worker', 'VERSION')
        open(fn, 'w').write(version)
